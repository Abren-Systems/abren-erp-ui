...
export const ledgerModule: BusinessDomain = {
  ...
  menuItems: [
    { label: 'Master Financial Calendar', route: 'LedgerFiscalCalendar', icon: 'calendar-days' },
    { label: 'Manage Financial Periods', route: 'LedgerManagePeriods', icon: 'calendar-range' },
