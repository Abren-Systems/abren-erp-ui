  ...
  <div class="flex h-full flex-col bg-[var(--app-canvas)]">
    <div class="flex shrink-0 items-center justify-between px-8 py-6 bg-white border-b border-[var(--color-neutral-200)]">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="m-0 text-xl font-bold tracking-tight text-[var(--color-neutral-900)]">Fiscal Periods</h1>
          <p class="mt-1 text-sm text-[var(--color-neutral-500)]">Define and lock financial periods for ledger integrity.</p>
        </div>
      </div>
