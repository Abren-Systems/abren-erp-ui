...
<template>
  ...
  >
    ...
    >
      <!-- Left: Branch/Company Context (Reserved) -->
      <div class="flex items-center gap-3">
        <!-- Future: Branch / Company Selectors -->
      </div>
      ...
      <div class="flex justify-center">
        <button
          type="button"
          class="inline-flex w-full max-w-md items-center gap-2 rounded-md border border-[color:var(--color-neutral-200)] bg-white px-3 py-2 text-sm text-[var(--color-neutral-600)] transition-colors hover:bg-[var(--color-neutral-100)]"
          @click="emit('search')"
        >
